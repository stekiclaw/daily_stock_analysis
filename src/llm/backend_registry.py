...
CODEX_OAUTH_BACKEND_ID = "codex_oauth"
...
# Backends that are neither LiteLLM nor a local CLI subprocess. codex_oauth
# speaks HTTP directly with a subscription credential DSA holds itself.
REMOTE_OAUTH_GENERATION_BACKEND_IDS = frozenset({CODEX_OAUTH_BACKEND_ID})
NON_LITELLM_GENERATION_BACKEND_IDS = (
    LOCAL_CLI_GENERATION_BACKEND_IDS | REMOTE_OAUTH_GENERATION_BACKEND_IDS
)
...
GENERATION_ONLY_BACKEND_IDS = NON_LITELLM_GENERATION_BACKEND_IDS - AGENT_CAPABLE_BACKEND_IDS
